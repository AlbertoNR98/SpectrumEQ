                                   ...
                                   juce::Slider& slider)
{
    ...
    g.setColour(Colour(86u, 191u, 240u));
    g.fillEllipse(bounds);

    //g.setColour(Colour(255u, 154u, 1u));    // Orange
    g.setColour(Colour(94u, 86u, 240u));
...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(SpectrumEQAudioProcessor& p) : audioProcessor(p)
{
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gDb : gain)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(0u, 172u, 1u) : Colours::darkgrey); // Green
